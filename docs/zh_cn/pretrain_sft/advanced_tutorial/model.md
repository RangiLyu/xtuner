...
| `Qwen3_5_VLTextDenseConfig` | Qwen3.5-VL Text      | Dense（VL 文本主干） | `Qwen3_5ForConditionalGeneration` |
...
| -------------------------------------- | ------------------------------ | -------------------- | ------------------------------------------- |
| `Gemma4Dense12BConfig`                 | `Gemma4DenseConfig`            | Dense                | 约 12B 参数，纯文本塔                       |
...
| `Qwen3_5_VLTextMoE35BA3BSplitConfig`   | `Qwen3_5_VLTextMoESplitConfig` | MoE（VL 文本主干）   | 约 35B 总参 / 约 3B 激活，拆分 checkpoint   |
| `Qwen3_5_VLTextMoE397BA17BSplitConfig` | `Qwen3_5_VLTextMoESplitConfig` | MoE（VL 文本主干）   | 约 397B 总参 / 约 17B 激活，拆分 checkpoint |
...
| `Qwen3_5_VLMoE35BA3SplitConfig`   | `Qwen3_5_BaseConfig`       | `Qwen3_5_VLTextMoE35BA3BSplitConfig`   | 约 35B 总参 / 约 3B 激活，拆分 MoE VL   |
| `Qwen3_5_VLMoE397BA17SplitConfig` | `Qwen3_5_BaseConfig`       | `Qwen3_5_VLTextMoE397BA17BSplitConfig` | 约 397B 总参 / 约 17B 激活，拆分 MoE VL |
| `Qwen3_5TimeSeriesMoE35BA3Config` | `Qwen3_5_VLMoE35BA3Config` | `Qwen3_5_VLTextMoE35BA3BConfig`        | 约 35B 总参 / 约 3B 激活，时序 VL       |
